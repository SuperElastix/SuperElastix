...
// Header file generated by CMake (should be in Build directory).
#include <../Applications/selxGitRevisionSha.h>
...
main( int ac, char * av[] )
{
  ...
  try
  {
    std::cout << "SuperElastix GIT Revision SHA-1: " << selx::gitRevisionSha << std::endl;
