...
if( UNIX )
  ...
  set( BOOST_BUILD_COMMAND ./b2 --with-program_options --with-filesystem --with-log address-model=64)
else()
  if( WIN32 )
    ...
    set( BOOST_BUILD_COMMAND b2.exe --with-program_options --with-filesystem --with-log address-model=64)
  endif()
endif()
