...
class MGH10(Dataset):
    ...
    def evaluate(self, superelastix, file_names):
        ...
        inverse_consistency_atlas_0, inverse_consistency_atlas_1 = inverse_consistency_labels(superelastix, file_names['label_file_names'], file_names['displacement_field_file_names_full_path'])
