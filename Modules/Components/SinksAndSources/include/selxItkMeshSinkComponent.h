...
#ifndef selxItkMeshSinkComponent_h
#define selxItkMeshSinkComponent_h
...
public:
  ...
  ItkMeshSinkComponent( const std::string & name, const LoggerInterface & logger );
...
#include "selxItkMeshSinkComponent.hxx"
#endif
#endif // #define selxItkMeshSinkComponent_h
