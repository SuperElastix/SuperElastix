...
#ifndef selxItkResampleFilterComponent_h
#define selxItkResampleFilterComponent_h
...
public:
  ...
  ItkResampleFilterComponent( const std::string & name, LoggerImpl & logger );
...
#include "selxItkResampleFilterComponent.hxx"
#endif
