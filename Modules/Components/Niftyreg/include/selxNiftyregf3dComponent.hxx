...
::RunRegistration()
{
  ...
  (*(this->m_warped_images.get()))[0] = std::shared_ptr< nifti_image >(outputWarpedImage[0], [](nifti_image* ptr){nifti_image_free(ptr); });
  (*(this->m_warped_images.get()))[1] = std::shared_ptr< nifti_image >(outputWarpedImage[1], [](nifti_image* ptr){nifti_image_free(ptr); });
  ...
  this->m_cpp_image = std::shared_ptr< nifti_image >(m_reg_f3d->GetControlPointPositionImage(), [](nifti_image* ptr){nifti_image_free(ptr);});
