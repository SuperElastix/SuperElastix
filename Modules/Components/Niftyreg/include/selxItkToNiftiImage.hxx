...
template<class ItkImageType, class NiftiPixelType>
void
ItkToNiftiImage< ItkImageType, NiftiPixelType >::SetNIfTIOrientationFromImageIO(typename ItkImageType::Pointer input, nifti_image* output, unsigned short int origdims, unsigned short int dims)
{
  //
  // use NIFTI method 2
