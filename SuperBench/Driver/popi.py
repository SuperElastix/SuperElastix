...
class POPI(object):
    def __init__(self, input_directory):
        ...
        for sub_directory in sub_directories:
            ...
            self.point_set_file_names.append((os.path.join(input_directory, sub_directory, 'pts', '00.mhd'),
                                              os.path.join(input_directory, sub_directory, 'pts', '50.mhd')))
            self.relative_output_file_names.append(os.path.join(sub_directory, '00->50.mhd'))
            ...
            self.point_set_file_names.append((os.path.join(input_directory, sub_directory, 'pts', '50.mhd'),
                                              os.path.join(input_directory, sub_directory, 'pts', '00.mhd')))
            self.relative_output_file_names.append(os.path.join(sub_directory, '50->00.mhd'))
